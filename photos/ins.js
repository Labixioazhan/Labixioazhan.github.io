    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://raw.githubusercontent.com/Labixioazhan/hexoBlogPhoto/master/min_photos/' + data.link[i];
          var src = 'https://raw.githubusercontent.com/Labixioazhan/hexoBlogPhoto/master/photos/' + data.link[i];
          ...
          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">\
                <a href="' + src + '" itemprop="contentUrl" data-size="1080x1080" data-type="' + type + '" data-target="' + src + '">\
                  <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="/labixioazhan.github.io/labixioazhan.github.io/photos/ins/img/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
